...
<qgis version="2.12.0-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="tikID">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="tikID" forceraster="0" symbollevels="1" type="categorizedSymbol">
    <categories>
      ...
      <category render="true" symbol="4" value="11" label="11"/>
      <category render="true" symbol="5" value="12" label="12"/>
      <category render="true" symbol="6" value="21" label="21"/>
      <category render="true" symbol="7" value="22" label="22"/>
      <category render="true" symbol="8" value="31" label="31"/>
      <category render="true" symbol="9" value="32" label="32"/>
      <category render="true" symbol="10" value="41" label="41"/>
      <category render="true" symbol="11" value="42" label="42"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="90"/>
          <prop k="color" v="210,199,72,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="tikID"/>
  ...
  <displayfield>tikID</displayfield>
  <label>0</label>
  <labelattributes>
